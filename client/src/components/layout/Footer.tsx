    ...
    <footer className="bg-white pt-24 pb-12 border-t border-gray-100">
      <div className="container">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-6">
              <img
                ...
                height="32"
              />
              <span className="text-xl font-medium tracking-tight text-[#222222]">
                DropDrop
              </span>
            </Link>
          ...
          {/* Product */}
          <div>
            <h4 className="text-[#222222] font-medium mb-6">
              {t("footer.product")}
            </h4>
            <ul className="space-y-4 text-[#666666] font-light">
              <li>
                <a
                  href="/#features"
                  className="hover:text-[#4CAF93] transition-colors"
                >
                  {t("footer.features")}
                </a>
              </li>
        ...
        <div className="pt-12 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-[#999999] font-medium uppercase tracking-[0.2em]">
                Designed with Care
              </span>
            </div>
          </div>
