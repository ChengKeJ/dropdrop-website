  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#FAFAFA]/80 backdrop-blur-md border-b border-[#E5E5E5]">
      <div className="container h-16 flex items-center justify-between">
        <PrefetchLink href="/" className="flex items-center gap-3 hover:opacity-100 transition-opacity z-50">
        ...
        <div className="flex items-center gap-3 md:gap-6">
          <div className="hidden md:flex items-center gap-6">
            <PrefetchLink href="/blog" className="text-sm text-[#666666] hover:text-[#222222] transition-colors">{t('nav.blog')}</PrefetchLink>
            <PrefetchLink href="/about" className="text-sm text-[#666666] hover:text-[#222222] transition-colors">{t('nav.about')}</PrefetchLink>
          </div>
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col gap-6 text-lg font-medium text-[#222222]">
              <PrefetchLink href="/blog" className="py-2 border-b border-gray-100">{t('nav.blog')}</PrefetchLink>
              <PrefetchLink href="/about" className="py-2 border-b border-gray-100">{t('nav.about')}</PrefetchLink>
